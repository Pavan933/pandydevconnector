    ...
    <div class="form">
      <div class="vue-csv-uploader-part-one">
        ...
        <div class="form-group csv-import-file">
          <input ref="csv" type="file" :class="inputClass" name="csv" @change.prevent="validFileMimeType" />
          <slot v-if="showErrorMessage" name="error">
        ...
        <div v-if="sample" class="vue-csv-mapping">
          <table :class="tableClass">
            ...
            <tbody>
              <tr v-for="(field, key) in fieldsToMap" :key="key">
                <td>{{ field.label }}</td>
                <td>
                  <select v-model="map[field.key]" :class="tableSelectClass" :name="`csv_uploader_map_${key}`">
                    <option v-if="canIgnore" :value="null">Ignore</option>
          ...
          <div v-if="url" class="form-group">
            <slot name="submit" :submit="submit">
              <input type="submit" :class="buttonClass" :value="submitBtnText" @click.prevent="submit" />
            </slot>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    validateMimeType(type) {
      return this.fileMimeTypes.includes(type)
    },
    load() {
      const _this = this
